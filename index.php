...
<html class="loading">
  ...
  <div class="content-body">
		...
		<div class="col-md-8">
			<div class="card">
				<div class="card-body text-center">
					<h4 class="mb-2"><strong>Black#Op</strong></h4>
    ...
    <option </option>
	            		...
	            		<option style="background:rgba(16, 15, 154, 0.281);color:rgb(255, 208, 0);color:white" value="gate/usd1cvv.php">Stripe Charge CVV: $1</option>
				<option style="background:rgba(16, 15, 154, 0.281);color:rgb(255, 208, 0);color:white" value="gate/usd1cnn.php">Stripe Charge CCN: $1</option>
				
				<option style="background:rgba(16, 15, 154, 0.281);color:rgb(255, 208, 0);color:white" value="gate/eur1cvv.php">Stripe Charge CVV: €1</option>
				<option style="background:rgba(16, 15, 154, 0.281);color:rgb(255, 208, 0);color:white" value="gate/eur1cnn.php">Stripe Charge CCN: €1</option>
</select>
	<br>										
...
<footer>
  <p>Crafted By<a href="https://t.me/BinnerBhaiya">@BinnerBhaiya</a></p>
</footer>
<script>
...
function RedirectUrl(){    
       window.location.href ="https://t.me/+764qsdFTm9hlODdk";
    }
...
if(total > 501){
  Swal.fire({title: 'YOU CAN NOT PERFORM THAT ACTION: REDUCE NUMBER OF CARDS TO <499', icon: 'warning', showConfirmButton: false, toast: true, position: 'top-end', timer: 3000});
  return false;
}
